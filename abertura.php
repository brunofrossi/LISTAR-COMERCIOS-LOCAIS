        ...
        <div class="frontside">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Oque você procura?</p>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="embed-responsive embed-responsive-16by9">
                <iframe src="https://www.youtube.com/embed/dAtd5Bw6RjM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div> <!-- ./card body -->
          </div> <!-- ./card -->
        </div> <!-- ./frontside -->
